...
public class DynamicLineChartManager {
    ...
    private SimpleDateFormat df = new SimpleDateFormat("HH:mm:ss.SSS");//设置日期格式
    ...
    public void addEntry(List<Integer> numbers) {
        ...
        for (int i = 0; i < numbers.size(); i++) {
            ...
            lineData.notifyDataChanged();
            lineChart.notifyDataSetChanged();
            //lineChart.setVisibleXRangeMaximum(6); //original
            //lineChart.moveViewToX(lineData.getEntryCount() - 5);

            lineChart.setVisibleXRangeMaximum(10);
            lineChart.moveViewToX(lineData.getEntryCount() - 9);
        }
    }

    public void addEntry(List<Integer> numbers, String timeStamp) {
    ...
    public void saveLineChart(String chartName){
        lineChart.setSaveEnabled(true);
        lineChart.saveToGallery(chartName, 100);
        //+df.format(System.currentTimeMillis())
        lineChart.saveToPath(chartName, "insole/data");
